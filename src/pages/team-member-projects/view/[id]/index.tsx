...
import { getTeamMemberProjectById } from 'apiSdk/team-member-projects';
...
function TeamMemberProjectViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Team Member Project Detail View
          </Text>
          {hasAccess('team_member_project', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/team-member-projects/edit/${data?.id}`} passHref legacyBehavior>
              <Button
